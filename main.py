...
if __name__ == '__main__':
    device_p = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
    print("the selected device is :", device_p)
    ...
    configure("tensorboard/run"+time.replace(" ", "_").replace(":", "_"), flush_secs=5)
