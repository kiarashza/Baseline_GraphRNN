...
def mmd_eval(generated_graph_list, original_graph_list):
...
def load_graph_list(fname,remove_self=True):
    ...
    for G in glist:
        ...
        #if remove_self:
        edges_with_selfloops = G.selfloop_edges()#G.remove_edges_from(nx.selfloop_edges(G))
        G.remove_edges_from(edges_with_selfloops)
...
if __name__ == '__main__':
    ...
    fname = "graphs/GraphRNN_MLP_lobster_4_128_pred_3000_1.dat"
    dataset = "lobster"
    # load the data
    ...
    generated_graphs =load_graph_list(fname)
